...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: PersonalizingWidget.routeName,
          path: PersonalizingWidget.routePath,
          builder: (context, params) => PersonalizingWidget(),
        ),
        FFRoute(
          name: FlowersWidget.routeName,
          path: FlowersWidget.routePath,
          builder: (context, params) => FlowersWidget(),
        ),
        FFRoute(
          name: GardenWidget.routeName,
          path: GardenWidget.routePath,
        ...
        FFRoute(
          ...
          builder: (context, params) => CameraWidget(
            initialValue: params.getParam<PlantType>(
              'initialValue',
              ParamType.Enum,
            ),
          ),
        ...
        FFRoute(
          name: FlowerWidget.routeName,
          path: FlowerWidget.routePath,
          asyncParams: {
            'plant': getDoc(['plants'], PlantsRecord.fromSnapshot),
          },
          builder: (context, params) => FlowerWidget(
        ...
        FFRoute(
          name: SuggestionWidget.routeName,
          path: SuggestionWidget.routePath,
          asyncParams: {
            'suggestion':
                getDoc(['suggestions'], SuggestionsRecord.fromSnapshot),
          },
          builder: (context, params) => SuggestionWidget(
            suggestion: params.getParam(
              'suggestion',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: SnapsWidget.routeName,
          path: SnapsWidget.routePath,
          builder: (context, params) => SnapsWidget(
            plant: params.getParam(
              'plant',
              ParamType.DataStruct,
              isList: false,
              structBuilder: PlantInformationStruct.fromSerializableMap,
            ),
          ),
        ),
        FFRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/PLATARA_LOGO_NO_GEM-Photoroom.png',
                    fit: BoxFit.contain,
                  ),
                )
