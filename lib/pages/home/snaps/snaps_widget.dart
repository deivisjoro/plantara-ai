...
import 'snaps_model.dart';
export 'snaps_model.dart';

class SnapsWidget extends StatefulWidget {
  const SnapsWidget({
    super.key,
    required this.plant,
  });

  final PlantInformationStruct? plant;

  static String routeName = 'Snaps';
  static String routePath = '/snaps';

  @override
  State<SnapsWidget> createState() => _SnapsWidgetState();
}

class _SnapsWidgetState extends State<SnapsWidget> {
  late SnapsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SnapsModel());
  }
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      '845ez09u' /* Free Premium Available */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .titleSmall
                                        .override(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              'gg54a9iv' /* Scientific Classifications */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'hi3zh35r' /* Calculate your plants
water ne... */
                                                ,
                                              ),
                                              style:
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'b3ycl7ft' /* Measure the light amount */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelSmall
